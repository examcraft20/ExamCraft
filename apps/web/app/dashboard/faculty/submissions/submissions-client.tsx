...
import { SubmissionsListClient } from "@/components/dashboard/faculty/submissions-list";
...
export function SubmissionsPageClient() {
  ...
  return <SubmissionsListClient initialQuestions={questions} institutionId={institutionId || ""} />;
}
