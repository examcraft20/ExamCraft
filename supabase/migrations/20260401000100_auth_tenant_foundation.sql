...
values
  ...
  ('global_templates.clone', 'Clone Global Templates', 'global_templates', 'Clone platform templates to institution'),
  ...
  ('ai.use', 'Use AI Features', 'ai', 'Access AI-powered question generation and syllabus extraction')
on conflict (code) do update
set
  name = excluded.name,
