...
import { TemplateListClient } from "@/components/dashboard/faculty/template-list";
  ...
  useEffect(() => {
    ...
    async function loadData() {
      ...
      try {
        ...
        const templatesData = await apiRequest<Template[]>("/content/templates", {
          method: "GET",
    ...
    return (
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/dashboard/faculty/templates/new">
