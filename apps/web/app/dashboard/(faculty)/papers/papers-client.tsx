...
import { PaperListClient } from "@/components/dashboard/faculty/paper-list";
...
export function PapersPageClient() {
  ...
  useEffect(() => {
    ...
    async function loadData() {
      ...
      try {
        ...
        const data = await apiRequest<Paper[]>("/content/papers", {
          method: "GET",
  ...
  return <PaperListClient initialPapers={papers} institutionId={institutionId || ""} />;
}
