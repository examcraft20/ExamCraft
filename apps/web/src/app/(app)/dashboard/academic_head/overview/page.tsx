...
import { DepartmentOverviewContent } from '@/components/analytics/department-overview';
...
export default function AcademicHeadOverviewPage() {
  ...
  useEffect(() => {
    ...
    async function validateAccess() {
      ...
      try {
        const contextResponse = await apiRequest<InstitutionContextResponse>("/institution/context", {
          method: "GET",
        ...
        const hasAcademicHeadRole = contextResponse.institutionContext.roleCodes?.includes("academic_head");
