...
export default function ReportsPage() {
  ...
  const load = (token: string, instId: string) => {
    setIsLoading(true);
    Promise.all([
      apiRequest<Question[]>("/questions", { method: "GET", accessToken: token, institutionId: instId }),
      apiRequest<Paper[]>("/papers", { method: "GET", accessToken: token, institutionId: instId }),
      apiRequest<{ users: any[] }>("/users/users", { method: "GET", accessToken: token, institutionId: instId }),
