    ...
    async function loadStats() {
      try {
        ...
        const [papersRes, questionsRes] = await Promise.all([
          apiRequest<any[]>("/papers", { method: "GET", accessToken: session.access_token, institutionId: institutionId || undefined }),
          apiRequest<any[]>("/questions", { method: "GET", accessToken: session.access_token, institutionId: institutionId || undefined })
        ]);
